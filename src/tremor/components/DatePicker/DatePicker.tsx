  ...
  return (
    <div
      ...
      className={cx(
        ...
        {
          "w-fit! border-none bg-transparent px-0 text-neutral-400 shadow-none": isDecorator,
          hidden: isSpace,
    ...
    >
      <span
        aria-hidden="true"
        className={cx("pointer-events-none block w-full text-left text-neutral-700 sm:text-sm", {
    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        <button ref={forwardedRef} className={cx(triggerStyles({ hasError }), className)} {...props}>
          ...
          <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left text-neutral-900 dark:text-neutral-50">
            {children ? (
              children
            ) : placeholder ? (
              <span className="text-neutral-400 dark:text-neutral-600">{placeholder}</span>
            ) : null}
          </span>
        </button>
...
const SingleDatePicker = ({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: we really want the initial value
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: we really want to run this on open change
  React.useEffect(() => {
    if (!open) {
      setMonth(date);
    }
            ...
            {presets && presets.length > 0 && (
              <div
                className={cx(
                  ...
                  "border-b border-neutral-200 dark:border-neutral-800 sm:border-b-0 sm:border-r",
                  "overflow-auto",
                )}
              >
          ...
          <div className="flex flex-col overflow-x-auto sm:flex-row sm:items-start">
            ...
            <div className="overflow-x-auto">
              <CalendarPrimitive
                ...
                initialFocus
                classNames={{
                  months: "flex flex-row divide-x divide-neutral-200 dark:divide-neutral-800 overflow-x-auto",
                }}
                {...props}
              />
              {showTimePicker && (
                <div className="flex items-center justify-evenly gap-x-3 border-t border-neutral-200 p-3 dark:border-neutral-800">
                  <div className="flex flex-1 items-center gap-x-2">
                    <span className="dark:text-neutral-30 text-neutral-700">{translations?.start ?? "Start"}:</span>
                    <TimeInput
                      value={startTime}
                  ...
                  <div className="flex flex-1 items-center gap-x-2">
                    <span className="dark:text-neutral-30 text-neutral-700">{translations?.end ?? "End"}:</span>
                    <TimeInput
                      value={endTime}
              ...
              <div className="border-t border-neutral-200 p-3 dark:border-neutral-800 sm:flex sm:items-center sm:justify-between">
                <p className="tabular-nums text-neutral-900 dark:text-neutral-50">
                  <span className="text-neutral-700 dark:text-neutral-300">{translations?.range ?? "Range"}:</span>{" "}
