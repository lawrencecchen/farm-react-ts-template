    ...
    return (
      ...
      >
        ...
        <DrawerPrimitives.Close asChild>
          <Button variant="ghost" className="aspect-square p-1 hover:bg-neutral-100 dark:hover:bg-neutral-400/10">
...
const DrawerFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
      className={cx(
        "flex flex-col-reverse border-t border-neutral-200 pt-4 dark:border-neutral-900 sm:flex-row sm:justify-end sm:space-x-2",
        className,
      )}
      {...props}
    />
