...
const TabsList = React.forwardRef<React.ElementRef<typeof TabsPrimitives.List>, TabsListProps>(
  ({ className, variant = "line", children, ...props }, forwardedRef) => (
    <TabsPrimitives.List ref={forwardedRef} className={cx(variantStyles[variant], className)} {...props}>
  ...
  switch (tabVariant) {
    case "line":
      return cx(
        ...
        "data-disabled:text-neutral-300 dark:data-disabled:text-neutral-700",
      );
    case "solid":
      return cx(
        // base
        ...
        // disabled
        "data-disabled:pointer-events-none data-disabled:text-neutral-400 data-disabled:opacity-50 dark:data-disabled:text-neutral-600",
      );
  }
}
...
>(({ className, ...props }, forwardedRef) => (
  <TabsPrimitives.Content ref={forwardedRef} className={cx("outline-hidden", focusRing, className)} {...props} />
));
