  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "w-9 font-medium text-sm sm:text-xs text-center text-neutral-400 dark:text-neutral-600 pb-2",
        row: "w-full mt-0.5",
        cell: cx("relative p-0 text-center focus-within:relative", "text-neutral-900 dark:text-neutral-50"),
        day: cx(
        ...
        day_disabled: "text-neutral-300! dark:text-neutral-700! line-through disabled:hover:bg-transparent",
          ...
          return (
            <div className="flex items-center justify-between">
              ...
              <div
                role="presentation"
                aria-live="polite"
                className="text-sm font-medium capitalize tabular-nums text-neutral-900 dark:text-neutral-50"
              >
              ...
              {today && (
                <span
                  className={cx("absolute inset-x-1/2 bottom-1.5 h-0.5 w-4 -translate-x-1/2 rounded-[2px]", {
                    ...
                    "bg-neutral-400! dark:bg-neutral-600!": selected && range_middle,
                    "bg-neutral-400 text-neutral-400 dark:bg-neutral-400 dark:text-neutral-600": disabled,
                  })}
                />
              )}
            </button>
