...
const inputStyles = tv({
  base: [
    ...
    [
      ...
      "file:border-solid file:border-neutral-300 file:bg-neutral-50 file:text-neutral-500 hover:file:bg-neutral-100 dark:file:border-neutral-800 dark:file:bg-neutral-950 dark:hover:file:bg-neutral-900/20 dark:file:disabled:border-neutral-700",
