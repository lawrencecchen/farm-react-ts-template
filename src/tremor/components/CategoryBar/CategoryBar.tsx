...
import { AvailableChartColors, type AvailableChartColorsKeys, getColorClassName } from "../../utils/chartColors";
import { cx } from "../../utils/cx";
import { Tooltip } from "../Tooltip/Tooltip";

const getMarkerBgColor = (marker: number | undefined, values: number[], colors: AvailableChartColorsKeys[]): string => {
...
const CategoryBar = React.forwardRef<HTMLDivElement, CategoryBarProps>(
  ({ values = [], colors = AvailableChartColors, marker, showLabels = true, className, ...props }, forwardedRef) => {
            ...
            >
              {marker.tooltip ? (
                <Tooltip asChild content={marker.tooltip}>
                  ...
                  >
                    <div aria-hidden className="absolute size-7 -translate-x-[45%] -translate-y-[15%]" />
                  </div>
                </Tooltip>
              ) : (
                <div
