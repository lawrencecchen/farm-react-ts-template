  ...
  <AccordionPrimitives.Header className="flex">
    ...
    >
      ...
      <RiAddLine
        className={cx(
          // base
          "size-5 shrink-0 transition-transform duration-150 ease-linear group-data-[state=open]:-rotate-45",
          // text color
...
>(({ className, children, ...props }, forwardedRef) => (
  <AccordionPrimitives.Content
    ref={forwardedRef}
    className={cx("data-[state=closed]:animate-accordionClose data-[state=open]:animate-accordionOpen transform-gpu")}
    {...props}
  >
    <div
      className={cx(
